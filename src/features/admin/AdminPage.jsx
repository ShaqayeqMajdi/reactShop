...
export default function AdminPage() {
  ...
  return (
    <div className="relative flex gap-8 container mx-auto font-Quicksand selection:bg-Cultured mb-6">
      ...
      <aside
        className={`fixed lg:static top-0 left-0 h-full w-72 bg-white border-r-2 border-gray-100 flex-col transition-transform duration-500 z-50
          ${
      ...
      >
        ...
        <nav className="p-4 space-y-4">
          <a
            href="#"
            className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-100 font-medium 
          ...
          <a
            href="#"
            className="flex items-center justify-between p-4 rounded-2xl bg-gray-100 font-medium 
          transition-all duration-500 group border-b-2 shadow-sm border-gray-200"
          >
            <div className="flex items-center space-x-3">
                  ...
                  <tr key={product.id}>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          className="group relative p-2 sm:p-3 bg-Cultured cursor-pointer text-indigo-600 
                        ...
                        >
                          ...
                          <span
                            className="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded-lg 
                          opacity-0 group-hover:opacity-100 transition-opacity duration-500 whitespace-nowrap"
                          >
                            Delete
                          </span>
                        </button>
