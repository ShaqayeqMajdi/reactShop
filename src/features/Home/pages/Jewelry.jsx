...
export default function Jewelry() {
  ...
  useEffect(() => {
    api.get("products/category/jewelery")
    ...
    <>
      ...
      overflow-hidden bg-linear-to-b from-white via-[#f5f5f5] to-[#e8e8e8]">
        ...
        <div className="relative z-10 flex flex-col items-center gap-3">
          <h1 className="text-6xl md:text-8xl font-bold text-gray-900 drop-shadow-sm">Jewelry</h1>
          <p className="text-gray-500 flex items-center gap-2 text-base">
            ...
            <span className="font-semibold text-gray-500">Jewelry</span>
          </p>
        </div>
      </div>
