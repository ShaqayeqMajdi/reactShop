...
export default function MenPage() {
  ...
  useEffect(() => {
    api.get("products/category/men's%20clothing")
  ...
  return (
    <>
     <div className="relative flex flex-col items-center justify-center w-full py-28 text-center font-Quicksand overflow-hidden bg-linear-to-b from-white via-[#f5f5f5] to-[#e8e8e8]">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 flex items-center gap-2 text-base">
            ...
            <span className="font-semibold text-gray-500">Men</span>
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 max-w-7xl mx-auto">
