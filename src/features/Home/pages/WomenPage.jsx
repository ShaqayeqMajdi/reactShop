...
export default function WomenPage() {
  ...
  useEffect(() => {
    api.get("products/category/women's%20clothing")
  ...
  return (
    <>
      ...
      overflow-hidden bg-linear-to-b from-white via-[#f5f5f5] to-[#e8e8e8]">
        ...
        <div className="relative z-10 flex flex-col items-center gap-2 -mt-10">
          ...
          <p className="text-gray-500 flex items-center gap-2 text-sm md:text-base">
            ...
            <span className="font-semibold text-gray-500">Women</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-2 container mx-auto p-4 justify-center">
